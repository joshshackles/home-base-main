...
- Profile completeness and profile completeness scoring now track identity, household, income, rental goals, references, and renter story.
...
- Rent calendar, rent calendar planning, utilities, maintenance, documents, and messages are promoted into guided journey cards.
