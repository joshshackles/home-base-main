...
- The packet now uses structured driver license, vehicle, license plate, housing agency, and case worker fields so landlords can review operational renter details without parsing free-form text.
