...
assertIncludes("src/lib/navigation/first-release.ts", "landlordNavGroups");
assertIncludes("src/components/admin/AdminCommandCenter.tsx", "request.reason || \"No reason provided.\"");
assertIncludes("src/app/admin/page.tsx", "AdminCommandCenter");
...
assertIncludes("src/app/landlord/page.tsx", "Set up your first rental workspace");
