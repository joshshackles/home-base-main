    ...
    <main className="mx-auto max-w-xl px-4 py-10 sm:px-6 lg:px-8">
      <div className="rounded-3xl border border-slate-200 bg-white p-8 shadow-sm">
        ...
        <p className="mt-3 leading-7 text-slate-600">
          Signed in as <strong>{user.email}</strong>. Use a strong password you do not reuse anywhere else.
        </p>
        ...
        <form action={changePasswordAction} className="mt-6 space-y-4">
          ...
          <label className="block"><span className="text-sm font-bold text-slate-700">New password</span><input className="mt-2 w-full rounded-2xl border border-slate-300 px-4 py-3 outline-none focus:border-brand-500 focus:ring-4 focus:ring-brand-100" name="newPassword" type="password" autoComplete="new-password" minLength={10} required /></label>
