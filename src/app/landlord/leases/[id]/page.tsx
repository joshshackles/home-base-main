...
import { signLandlordLease } from "@/app/landlord/actions";
    ...
    <main className="mx-auto max-w-7xl px-4 py-10 sm:px-6 lg:px-8">
      ...
      <section className="grid gap-6 lg:grid-cols-[1fr_360px]">
        ...
        <aside className="space-y-6">
          <div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
            <h2 className="text-xl font-black text-slate-950">Landlord signature</h2>
            {!request ? <p className="mt-3 text-sm text-slate-600">No landlord signature request is assigned to you.</p> : isExpired ? (
