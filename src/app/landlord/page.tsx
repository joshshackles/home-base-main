...
import { Building2, ClipboardList, Home, Inbox, Plus } from "lucide-react";
...
export default async function LandlordDashboardPage() {
  ...
  const [propertyCount, unitCount, availableCount, leadCount, applicationCount] = await Promise.all([
